...
**nf-core/bacass** is a bioinformatics best-practise analysis pipeline for
...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/bacass -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```
