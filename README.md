...
**nf-core/bacass** is a bioinformatics best-practice analysis pipeline for Simple bacterial assembly and annotation.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```bash
   nextflow run nf-core/bacass -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run nf-core/bacass --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```
