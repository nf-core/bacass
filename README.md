...
```bash
nextflow run nf-core/bacass -profile test,<docker/singularity/conda/institute>
```
...
```bash
nextflow run nf-core/bacass -profile <docker/singularity/conda/institute> --reads '*_R{1,2}.fastq.gz' --genome GRCh37
```
...
For further information or help, don't hesitate to get in touch on [Slack](https://nfcore.slack.com/channels/bacass) (you can join with [this invite](https://nf-co.re/join/slack)).
