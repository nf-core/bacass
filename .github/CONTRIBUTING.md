...
Hi there!
Many thanks for taking an interest in improving nf-core/bacass.
...
For further information/help, please consult the [nf-core/bacass documentation](https://nf-co.re/nf-core/bacass/docs) and don't hesitate to get in touch on the nf-core Slack [#bacass](https://nfcore.slack.com/channels/bacass) channel ([join our Slack here](https://nf-co.re/join/slack)).
