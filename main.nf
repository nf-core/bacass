...
params.skip_kraken2 ?: (params.kraken2db ?: {exit 1, "Missing Kraken2 DB arg"} : kraken2db = file(params.kraken2db))
kraken2db.exists() ?: '' : {exit 1, "Missing Kraken2 DB: ${kraken2db}"}
