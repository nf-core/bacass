...
workflow PIPELINE_INITIALISATION {
    ...
    Channel
        ...
        .map {
            ...
            if (!file(fastq_2)) {
                return [ meta.id, meta + [ single_end:true ], [ file(fastq_1) ], file(longreads), fast5 ]
            } else {
                return [ meta.id, meta + [ single_end:false ], [ file(fastq_1), file(fastq_2) ], file(longreads), fast5 ]
            }
        }
        .groupTuple()
        .map { samplesheet ->
